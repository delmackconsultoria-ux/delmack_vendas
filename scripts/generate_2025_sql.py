#!/usr/bin/env python3
"""
Script para gerar SQL de importação de dados de 2025
...
OUTPUT_FILE = "/home/ubuntu/delmack_real_estate/scripts/import_2025_data.sql"
...
def generate_sql():
    """Gera arquivo SQL com dados de 2025"""
    
    print("Gerando SQL de importacao de 2025...")
    ...
    with open(OUTPUT_FILE, 'w', encoding='utf-8') as sql_file:
        # Cabecalho
        sql_file.write("-- =====================================================\n")
        sql_file.write("-- Importacao de Dados Historicos 2025 - Delmack\n")
        ...
        for month_num in range(1, 13):
            ...
            if not file_path:
                print(f"Arquivo nao encontrado para {month_name}/2025")
                continue
            ...
            try:
                ...
                sql_file.write(f"-- {month_name.upper()} 2025\n")
                ...
                for row_idx, row in enumerate(ws.iter_rows(min_row=4, values_only=True), start=4):
                    try:
                        ...
                        # Gerar ID unico
                        sale_id = f"hist-2025-{month_num:02d}-{month_imported+1:05d}"
