...
const FIELD_LABELS: Record<string, string> = {
  ...
  listingStore: "Loja Angariadora",
  sellingStore: "Loja Vendedora",
  team: "Equipe",
  region: "Região",
  managementResponsible: "Responsável pela Gestão",
  deedStatus: "Status de Escrituração",
  bankName: "Banco",
  financedAmount: "Valor Financiado",
  bankReturnPercentage: "Percentual Retorno Bancário",
  bankReturnAmount: "Valor Retorno Bancário",
  observations: "Observações",
  wasRemoved: "Baixado",
  priceDiscount: "Desconto no Preço",
  listingToSaleDays: "Dias de Angariação até Venda",
  commissionPaymentDate: "Data de Recebimento",
  commissionAmountReceived: "Valor Recebido",
  commissionPaymentBank: "Banco Pagador",
  commissionPaymentMethod: "Forma de Pagamento",
  commissionPaymentObservations: "Observações do Pagamento",
  listingDate: "Data da Angariação",
  entryPercentage: "Percentual da Entrada",
  contractNumber: "Número do Contrato",
  contractSignatureDate: "Data de Assinatura do Contrato",
};
